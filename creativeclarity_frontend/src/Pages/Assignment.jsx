...
const AssignmentsPage = () => {
  ...
  const toggleCreateModal = () => {
    resetNewAssignment(); // Reset the assignment state when opening the create modal
  ...
  const handleCreate = async (e) => {
    e.preventDefault();
    const url = 'http://localhost:8080/api/assignments/postassignmentrecord';
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (createModalRef.current && !createModalRef.current.contains(event.target)) setIsCreateModalOpen(false);
      ...
      <main className="main-content">
        ...
        <section className="assignments-section">
          <div className="section-header">
            ...
            <button className="new-assignment-button" onClick={toggleCreateModal}>+ New Assignment</button>
          </div>
            ...
            <div className="modal" ref={createModalRef}>
              ...
              <form onSubmit={handleCreate}>
                ...
                <input
                  ...
                  required
                />
                <button type="submit" className='submit-button'>Save Assignment</button>
                <button type="button" onClick={toggleCreateModal} className='close-button'>Cancel</button>
              </form>
            </div>
          </div>
        )}
